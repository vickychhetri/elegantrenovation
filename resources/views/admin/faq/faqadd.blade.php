          ...
          <div class="col-md-12">
            <div class='common-card'>
              ...
              <div class='mb-3 mb-md-4'>
                <div>
                  <h4 class='m-0 lh-normal'>Add FAQs</h4>
                </div>
              </div>
              <div class='card-form-wrapper'>
                <form name="edit_profile" class="edit-profile-form" method="post" action="{{route('admin.faqstore')}}">
                    @csrf
                  <!-- Name -->
                  <div class="mb-3">
                    <label for="name">Question</label>
                    <input type="text" class="form-control" placeholder="Question"
                           value="" id="question"  name="title" required />
                  </div>
                  <!-- Answer -->
                  <div class="mb-4">
